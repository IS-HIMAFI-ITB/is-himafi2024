...
export function News() {
    return (
        ...
        style={{
            ...
            <h1 className="text-center text-3xl md:text-6xl font-extrabold tracking-widest pb-10 pt-10">SELAMAT DATANG MASSA FISIKA&apos;23</h1>
            <div className="flex flex-col lg:flex-row justify-between gap-20 pb-4 text-justify">
                <div>
                    <p className="text-center pb-2 font-black text-2xl">
